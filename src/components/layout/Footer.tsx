    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-300">
              <div className="flex items-center">
                ...
                <span>(92) 99150-2888</span>
              </div>
              <div className="flex items-center">
                <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span>cinthiaturismoregional@gmail.com</span>
              </div>
              <div className="flex items-center">
                <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; 2024 Turismo na Amazônia. Todos os direitos reservados.</p>
          <div className="mt-2 space-x-4">
            ...
            <span>•</span>
            <a href="#" className="hover:text-green-400 transition-colors">Política de Cancelamento</a>
          </div>
        </div>
      </div>
    </footer>
